class EpisodeStrings {
  ...
  static String buttonMarkAllWatched = "Mark All Watched";
  static String titleAddShow = "Add Show";
  static String titleMyShows = "My Shows";
  static String titleWelcomeBack = "Welcome Back!";
}
